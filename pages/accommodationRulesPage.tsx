  ...
  render(): b.IBobrilNode {
    return (
      <div style={infoPagesStyle.wrapperStyle}>
        <h1 style={infoPagesStyle.h1Style}>Ubytovací řád objektu</h1>
        ...
        <p style={infoPagesStyle.paragraphStyle}>Domácí mazlíčky prosím nechejte doma.</p>
        <p style={infoPagesStyle.paragraphStyle}>Host je povinen uhradit cenu za ubytování dle platného ceníku.</p>
        <p style={infoPagesStyle.paragraphStyle}>
          Není povoleno ubytovat osoby, které nebyly ubytovateli řádně
          přihlášeny k ubytování.
        </p>
        <p style={infoPagesStyle.paragraphStyle}>Při ukončení pobytu host předá pokoj pověřené osobě.</p>
        <p style={infoPagesStyle.paragraphStyle}>
        ...
        <p style={infoPagesStyle.paragraphStyle}>Uvítáme všechny návrhy na zlepšení provozu.</p>
        ...
        <h2 style={infoPagesStyle.h2Style}>Kontakt na majitele:</h2>
        <p style={infoPagesStyle.paragraphStyle}>Martin Jiráský &nbsp;&nbsp; +420 720 630 136</p>
      </div>
    );
  }
}
